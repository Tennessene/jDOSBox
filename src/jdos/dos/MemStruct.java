...
public class MemStruct {
    public /*Bitu*/int GetIt(/*Bitu*/int size, /*PhysPt*/long addr) {
		switch (size) {
		case 1:return Memory.mem_readb(pt+addr);
		case 2:return Memory.mem_readw(pt+addr);
		case 4:return (int)Memory.mem_readd(pt+addr);
		}
		return 0;
	}
	public void SaveIt(/*Bitu*/int size,/*PhysPt*/long addr,/*Bitu*/int val) {
		switch (size) {
	...
	void SetPt(/*RealPt*/long addr) { pt=Memory.Real2Phys(addr);}

	protected /*PhysPt*/long pt;
}
