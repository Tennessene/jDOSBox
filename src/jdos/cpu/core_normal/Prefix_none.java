...
static private final mov[] MovEbGb = new mov[] {
    ...
    static {
        ...
        ops[0x04] = new OP() {
            final public int call() {
                reg_eax.low(ADDB(Fetchb.call(),reg_eax.low()));
                return HANDLED;
            }
        };
        ops[0x204] = ops[0x04];
        ...
        ops[0x05] = new OP() {
            final public int call() {
                reg_eax.word(ADDW(Fetchw.call(),reg_eax.word()));
                return HANDLED;
            }
        };
        ...
        ops[0x0c] = new OP() {
            final public int call() {
                reg_eax.low(ORB(Fetchb.call(),reg_eax.low()));
                return HANDLED;
            }
        };
        ops[0x20c] = ops[0x0c];
        ...
        ops[0x0d] = new OP() {
            final public int call() {
                reg_eax.word(ORW(Fetchw.call(),reg_eax.word()));
                return HANDLED;
            }
        };
        ...
        ops[0x14] = new OP() {
            final public int call() {
                reg_eax.low(ADCB(Fetchb.call(),reg_eax.low()));
                return HANDLED;
            }
        };
        ops[0x214] = ops[0x14];
        ...
        ops[0x15] = new OP() {
            final public int call() {
                reg_eax.word(ADCW(Fetchw.call(),reg_eax.word()));
                return HANDLED;
            }
        };
        ...
        ops[0x1c] = new OP() {
            final public int call() {
                reg_eax.low(SBBB(Fetchb.call(),reg_eax.low()));
                return HANDLED;
            }
        };
        ops[0x21c] = ops[0x1c];
        ...
        ops[0x1d] = new OP() {
            final public int call() {
                reg_eax.word(SBBW(Fetchw.call(),reg_eax.word()));
                return HANDLED;
            }
        };
        ...
        ops[0x24] = new OP() {
            final public int call() {
                reg_eax.low(ANDB(Fetchb.call(),reg_eax.low()));
                return HANDLED;
            }
        };
        ops[0x224] = ops[0x24];
        ...
        ops[0x25] = new OP() {
            final public int call() {
                reg_eax.word(ANDW(Fetchw.call(),reg_eax.word()));
                return HANDLED;
            }
        };
        ...
        ops[0x2c] = new OP() {
            final public int call() {
                reg_eax.low(SUBB(Fetchb.call(),reg_eax.low()));
                return HANDLED;
            }
        };
        ops[0x22c] = ops[0x2c];
        ...
        ops[0x2d] = new OP() {
            final public int call() {
                reg_eax.word(SUBW(Fetchw.call(),reg_eax.word()));
                return HANDLED;
            }
        };
        ...
        ops[0x34] = new OP() {
            final public int call() {
                reg_eax.low(XORB(Fetchb.call(),reg_eax.low()));
                return HANDLED;
            }
        };
        ops[0x234] = ops[0x34];
        ...
        ops[0x35] = new OP() {
            final public int call() {
                reg_eax.word(XORW(Fetchw.call(),reg_eax.word()));
                return HANDLED;
            }
        };
        ...
        ops[0x9a] = new OP() {
            final public int call() {
                Flags.FillFlags();
                /*Bit16u*/int newip=Fetchw.call();/*Bit16u*/int newcs=Fetchw.call();
        ...
        ops[0xa9] = new OP() {
            final public int call() {
                TESTW(Fetchw.call(),reg_eax.word());
                return HANDLED;
            }
        };
        ...
        ops[0xe0] = new OP() {
            final public int call() {
                if (TEST_PREFIX_ADDR()!=0) {
                    ...
                    JumpCond16_b(reg_ecx.dword()!=0 && !Flags.get_ZF());
                } else {
                    reg_ecx.word(reg_ecx.word()-1);
                    JumpCond16_b(reg_ecx.word()!=0 && !Flags.get_ZF());
                }
                return CONTINUE;
            }
        };
        ...
        ops[0xe2] = new OP() {
            final public int call() {
                if (TEST_PREFIX_ADDR()!=0) {
                    reg_ecx.dword(reg_ecx.dword()-1);
                    JumpCond16_b(reg_ecx.dword()!=0);
                } else {
                    reg_ecx.word(reg_ecx.word()-1);
                    JumpCond16_b(reg_ecx.word()!=0);
                }
                return CONTINUE;
            }
        };
        ...
        ops[0xe3] = new OP() {
            final public int call() {
                JumpCond16_b((reg_ecx.dword() & AddrMaskTable[prefixes& PREFIX_ADDR])==0);
                return CONTINUE;
            }
        };
