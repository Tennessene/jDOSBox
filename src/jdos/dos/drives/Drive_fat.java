...
public class Drive_fat extends Dos_Drive {
    ...
    static public class fatFile extends DOS_File {
        ...
        public boolean Write(byte[] data,/*Bit16u*/IntRef size) {
            ...
            if (!finalizeWrite)
                if(curSectOff>0 && loadedSector) myDrive.loadedDisk.Write_AbsoluteSector(currentSector, sectorBuffer, 0);
    ...
    private /*Bit32u*/long getClusterValue(/*Bit32u*/long clustNum) {
        /*Bit32u*/long fatoffset=0;
        /*Bit32u*/long fatsectnum;
        /*Bit32u*/long fatentoff;
        /*Bit32u*/long clustValue=0;
    ...
    private void setClusterValue(/*Bit32u*/long clustNum, /*Bit32u*/long clustValue) {
        ...
        switch(fattype) {
            case FAT12: {
                /*Bit16u*/int tmpValue = pfatSectBuffer.readw((int)fatentoff);
                if((clustNum & 0x1)!=0) {
                    clustValue &= 0xfff;
                    clustValue <<= 4;
                    tmpValue &= 0xf;
    ...
    private boolean getFileDirEntry(String filename, DirEntry useEntry, /*Bit32u*/LongRef dirClust, /*Bit32u*/LongRef subEntry) {
        ...
        if (!filename.endsWith("\\")) {
            ...
            while(parts.length>index) {
                ...
                if(!FindNextInternal(currentClust, Bios_disk.imgDTA, foundEntry)) break;
                else {
                    //Found something. See if it's a directory (findfirst always finds regular files)
                    StringRef find_name=new StringRef();/*Bit16u*/IntRef find_date=new IntRef(0),find_time=new IntRef(0);/*Bit32u*/LongRef find_size=new LongRef(0);/*Bit8u*/ShortRef find_attr=new ShortRef();
        ...
        Bios_disk.imgDTA.SetDirID(0);
        if(!FindNextInternal(currentClust, Bios_disk.imgDTA, foundEntry)) return false;
    ...
    private boolean getDirClustNum(String dir, /*Bit32u*/LongRef clustNum, boolean parDir) {
        ...
        if (!dir.endsWith("\\")) {
            ...
            while(parts.length>index) {
                ...
                if(!FindNextInternal(currentClust, Bios_disk.imgDTA, foundEntry)){
                    return false;
                } else {
                    StringRef find_name=new StringRef();/*Bit16u*/IntRef find_date=new IntRef(0),find_time=new IntRef(0);/*Bit32u*/LongRef find_size=new LongRef(0);/*Bit8u*/ShortRef find_attr=new ShortRef();
                    Bios_disk.imgDTA.GetResult(find_name,find_size,find_date,find_time,find_attr);
    ...
    public /*Bit32u*/long getAbsoluteSectFromChain(/*Bit32u*/long startClustNum, /*Bit32u*/long logicalSector) {
        /*Bit32s*/long skipClust = logicalSector / bootbuffer.sectorspercluster;
        /*Bit32u*/long sectClust = logicalSector % bootbuffer.sectorspercluster;

        /*Bit32u*/long currentClust = startClustNum;
        /*Bit32u*/long testvalue;
    ...
    public void deleteClustChain(/*Bit32u*/long startCluster) {
        /*Bit32u*/long testvalue;
        /*Bit32u*/long currentClust = startCluster;
        boolean isEOF = false;
        while(!isEOF) {
            testvalue = getClusterValue(currentClust);
            if(testvalue == 0) {
    ...
    public /*Bit32u*/long appendCluster(/*Bit32u*/long startCluster) {
        ...
        /*Bit32u*/long newClust = getFirstFreeClust();
        /* Drive is full */
    ...
    public Drive_fat(String sysFilename, /*Bit32u*/long bytesector, /*Bit32u*/long cylsector, /*Bit32u*/long headscyl, /*Bit32u*/long cylinders, /*Bit32u*/long startSector) {
        ...
        if(filesize > 2880) {
            ...
            if(mbrData.magic1!= 0x55 ||	mbrData.magic2!= (byte)0xaa) Log.log_msg("Possibly invalid partition table in disk image.");
        ...
        /*Bit32u*/long RootDirSectors = ((bootbuffer.rootdirentries * 32) + (bootbuffer.bytespersector - 1)) / bootbuffer.bytespersector;
        /*Bit32u*/long DataSectors;
    ...
    public boolean AllocationInfo(/*Bit16u*/IntRef _bytes_sector,/*Bit8u*/ShortRef _sectors_cluster,/*Bit16u*/IntRef _total_clusters,/*Bit16u*/IntRef _free_clusters) {
        /*Bit32u*/LongRef hs=new LongRef(0), cy=new LongRef(0), sect=new LongRef(0),sectsize=new LongRef(0);
        /*Bit32u*/long countFree = 0;
        /*Bit32u*/long i;
    ...
    public /*Bit8u*/short GetMediaByte() { return loadedDisk.GetBiosType(); }

    public DOS_File FileCreate(String name,/*Bit16u*/int attributes) {
        DirEntry fileEntry = new DirEntry();
        /*Bit32u*/LongRef dirClust=new LongRef(0), subEntry=new LongRef(0);
        String dirName;
        byte[] pathName=new byte[11];

        /*Bit16u*/int save_errorcode=Dos.dos.errorcode;
    ...
    public boolean FileExists(String name) {
        DirEntry fileEntry = new DirEntry();
        /*Bit32u*/LongRef dummy1=new LongRef(0), dummy2=new LongRef(0);
    ...
    private boolean FindNextInternal(/*Bit32u*/long dirClustNumber, Dos_DTA dta, DirEntry foundEntry) {
        DirEntry[] sectbuf=new DirEntry[16]; /* 16 directory entries per sector */
        /*Bit32u*/long logentsector; /* Logical entry sector */
        /*Bit32u*/int entryoffset;  /* Index offset within sector */
        /*Bit32u*/long tmpsector;
        /*Bit8u */ShortRef attrs=new ShortRef();
        /*Bit16u*/int dirPos;
        ...
        while (true) {
            ...
            if ((~attrs.value & sectbuf[entryoffset].attrib & (Dos_system.DOS_ATTR_DIRECTORY | Dos_system.DOS_ATTR_HIDDEN | Dos_system.DOS_ATTR_SYSTEM) )!=0)  continue;
            if(!Drives.WildFileCmp(find_name,srch_pattern.value)) continue;
    ...
    public boolean directoryBrowse(/*Bit32u*/long dirClustNumber, DirEntry useEntry, /*Bit32s*/int entNum) {
        DirEntry[] sectbuf=new DirEntry[16];	/* 16 directory entries per sector */
        /*Bit32u*/long logentsector;	/* Logical entry sector */
        /*Bit32u*/int entryoffset = 0;	/* Index offset within sector */
        /*Bit32u*/long tmpsector;
        /*Bit16u*/int dirPos = 0;
    ...
    public boolean MakeDir(String dir) {
        /*Bit32u*/LongRef dummyClust=new LongRef(0), dirClust=new LongRef(0);
        DirEntry tmpentry = new DirEntry();
        String dirName;
        byte[] pathName=new byte[11];
    ...
    public boolean Rename(String oldname,String newname) {
        ...
        /*Bit32u*/LongRef dirClust1=new LongRef(0), subEntry1=new LongRef(0);
        ...
        /*Bit32u*/LongRef dirClust2=new LongRef(0), subEntry2=new LongRef(0);
    ...
    public boolean TestDir(String dir) {
        /*Bit32u*/LongRef dummyClust=new LongRef(0);
