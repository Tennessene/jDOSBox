    ...
    static {
        ...
        ops[0x283] = new OP() {
            final public int call() {
                ...
                if (rm >= 0xc0) {
                    /*Bit32u*/long id=((int)Fetchbs()) & 0xFFFFFFFFl;
                    Reg r = Modrm.GetEArd[rm];
                    switch (which) {
        ...
        ops[0x29a] = new OP() {
            final public int call() {
                /*Bit32u*/long newip=Fetchd();/*Bit16u*/int newcs=Fetchw();
                FillFlags();
        ...
        ops[0x2c7] = new OP() {
            final public int call() {
                ...
                else {/*PhysPt*/long eaa=getEaa(rm);Memory.mem_writed(eaa,Fetchd());}
                return HANDLED;
            }
        };
