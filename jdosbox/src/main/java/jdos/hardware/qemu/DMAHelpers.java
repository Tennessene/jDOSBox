...
public class DMAHelpers {
    ...
    static private final DMA.DMAIOFunc bdrv_aio_readv = (bs, sector_num, iov, nb_sectors, cb, opaque) -> Block.bdrv_aio_readv(bs, sector_num, iov, nb_sectors, cb, opaque);

    static private final DMA.DMAIOFunc bdrv_aio_writev = (bs, sector_num, iov, nb_sectors, cb, opaque) -> Block.bdrv_aio_writev(bs, sector_num, iov, nb_sectors, cb, opaque);
